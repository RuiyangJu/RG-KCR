...
def main(gt_dir, pred_dir, output_csv):
    gt_dir = Path(gt_dir)
    ...
    for fname in common_files:
        ...
        cer = edit_distance / len(gt_text) if len(gt_text) > 0 else 0
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Compute CER between GT and prediction txt files."
    )
    ...
    main(args.gt_dir, args.pred_dir, args.output_csv)
...
def main():
    ...
    ap.add_argument("--gt_dir", type=str, required=True, help="Folder of classification_gt jsons")
    ap.add_argument("--pred_dir", type=str, required=True, help="Folder of classification_results jsons")

...
* Notably, if you want to train/valid/test on both the **real** and **synthetic** datasets together, please make sure that the image names across the two datasets are **different**.

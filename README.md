...
* Please place the folder `Pretrained_Model_Kuzushiji_Detection` in `./`.
  ```
    yolo val model='./Pretrained_Model_Kuzushiji_Detection/yolov9m.pt' data=./Kuzushiji_Character_Detection_Dataset/meta_raw.yaml split='test' save_txt=True save_conf=True conf=0.1 name=test_raw_yolov9m
    yolo val model='./Pretrained_Model_Kuzushiji_Detection/yolov10m.pt' data=./Kuzushiji_Character_Detection_Dataset/meta_raw.yaml split='test' save_txt=True save_conf=True conf=0.1 name=test_raw_yolov10m
    yolo val model='./Pretrained_Model_Kuzushiji_Detection/yolo11m.pt' data=./Kuzushiji_Character_Detection_Dataset/meta_raw.yaml split='test' save_txt=True save_conf=True conf=0.1 name=test_raw_yolo11m
    yolo val model='./Pretrained_Model_Kuzushiji_Detection/yolo12m.pt' data=./Kuzushiji_Character_Detection_Dataset/meta_raw.yaml split='test' save_txt=True save_conf=True conf=0.1 name=test_raw_yolo12m
    yolo val model='./Pretrained_Model_Kuzushiji_Detection/rtdetr-l.pt' data=./Kuzushiji_Character_Detection_Dataset/meta_raw.yaml split='test' save_txt=True save_conf=True conf=0.1 name=test_raw_rtdetr-l
  ```
...
* Please place the folder `Pretrained_Model_Kuzushiji_Detection` in `./`.
  ```
    yolo val model='./Pretrained_Model_Kuzushiji_Detection/yolov9m.pt' data=./Kuzushiji_Character_Detection_Dataset/meta_aug.yaml split='test' save_txt=True save_conf=True conf=0.1 name=test_aug_yolov9m
    yolo val model='./Pretrained_Model_Kuzushiji_Detection/yolov10m.pt' data=./Kuzushiji_Character_Detection_Dataset/meta_aug.yaml split='test' save_txt=True save_conf=True conf=0.1 name=test_aug_yolov10m
    yolo val model='./Pretrained_Model_Kuzushiji_Detection/yolo11m.pt' data=./Kuzushiji_Character_Detection_Dataset/meta_aug.yaml split='test' save_txt=True save_conf=True conf=0.1 name=test_aug_yolo11m
    yolo val model='./Pretrained_Model_Kuzushiji_Detection/yolo12m.pt' data=./Kuzushiji_Character_Detection_Dataset/meta_aug.yaml split='test' save_txt=True save_conf=True conf=0.1 name=test_aug_yolo12m
    yolo val model='./Pretrained_Model_Kuzushiji_Detection/rtdetr-l.pt' data=./Kuzushiji_Character_Detection_Dataset/meta_aug.yaml split='test' save_txt=True save_conf=True conf=0.1 name=test_aug_rtdetr-l
  ```

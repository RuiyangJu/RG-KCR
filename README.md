...
* And then we randomly split the resulting dataset into training, validation, and test sets with a ratio of 8:1:1, resulting in 800 training images, 100 validation images, and 100 test images.

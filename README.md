...
* Please revise the `/path/to/data` in `./Kuzushiji_Character_Detection_Dataset/meta.yaml`.
  ```
    ...
    yolo detect train model=rtdetr-l.pt data=./Kuzushiji_Character_Detection_Dataset/meta_raw.yaml epochs=100 batch=16 imgsz=640 device=0 workers=8 optimizer=SGD lr0=0.001 name=train_rtdetr-l
  ```
